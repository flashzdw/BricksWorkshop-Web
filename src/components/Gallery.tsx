  ...
  return (
    <section id="gallery" ref={containerRef} className="py-24 sm:py-32 bg-zinc-50 overflow-hidden">
      ...
      <div className="w-full flex flex-col gap-6 sm:gap-8">
        ...
        <div className="relative w-full overflow-hidden flex gap-6 sm:gap-8">
          <div className="flex animate-marquee-left gap-6 sm:gap-8 min-w-max">
        ...
        <div className="relative w-full overflow-hidden flex gap-6 sm:gap-8">
          <div className="flex animate-marquee-right gap-6 sm:gap-8 min-w-max">
