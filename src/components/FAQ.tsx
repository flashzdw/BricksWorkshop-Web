...
const faqs = [
  ...
  },
  {
    ...
    answer: "非常有帮助。VEX 机器人世界锦标赛（VEX Worlds）是吉尼斯世界纪录认证的全球最大规模机器人赛事。我们 8009 战队屡次在国内外各级 VEX 比赛中获奖，这不仅能锻炼综合能力，也是申请国内外知名学府、科技特长生的重要加分项。"
  },
  {
    question: "滨江路校区的上课频率和班型是怎样的？",
    answer: "我们采用小班化教学（通常 4-6 人/班），以确保每位学员都能得到导师的充分关注。上课频率一般为每周 1-2 次，每次 90-120 分钟，具体可根据孩子的年龄段和所处阶段（如 8009 战队集训班）进行调整。"
  }
];
